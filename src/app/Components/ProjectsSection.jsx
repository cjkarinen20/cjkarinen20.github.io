...
const projectsData = [
    ...
    },
    {
        ...
        description: "A narrative horror game developed within a week for for Itch.io ScreamJam 2024.",
        fullDescription: "Voice Of The Valley is a first-person narrative horror game developed for Itch.io ScreamJam 2024. Players explore an empty reservation, uncovering a chilling story as they navigate through environmental puzzles. The game emphasizes atmosphere, storytelling and exploration, creating an immersive experience that keeps players on edge. Players must explore the environment to find the tools need to clear blocked paths and access new areas. I served as the Project Manager, Head Narrative Designer, Level Builder, Gameplay Programmer and voice actor for this project. My main responsibilities as the Project Manager included task delegation, timeline management, and ensuring effective communication among team members to meet our tight development schedule. For many of us involved, this project was an excercise in semi-open map design and puzzle-based exploration mechanics.",
    ...
    },
    {
        ...
        fullDescription: "Drop Dead is an intense cooperative board game designed for 1 to 4 players, where players work together to survive the undead and gather parts to fix their car. Set in a post-apocalyptic world, players must strategize, manage resources, and utilize unique character abilities to fend off the undead and achieve victory. The game features modular map tiles, 4 character classes, and event carts that introduce unexpected variety to each playthrough.",
    ...
    },
    {
        ...
        description: "Scaled-up version of the classic arcade game, reimagined for VR.",
        fullDescription: "Whack-A-Bot VR is an immersive virtual reality adaptation of the classic arcade game, where players use motion controllers to destroy robotic targets. The game features advanced object physics and a dynamic inverse kinematics (IK) system to create a realistic virtual body.",
